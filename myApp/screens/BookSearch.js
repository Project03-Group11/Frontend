    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        <View style={styles.filterRow}>
          <TouchableOpacity onPress={() => setSearchType('title')} style={searchType === 'title' ? styles.activeFilterButton : styles.filterButton}>
            <Text style={styles.filterButtonText}>Title</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setSearchType('id')} style={searchType === 'id' ? styles.activeFilterButton : styles.filterButton}>
            <Text style={styles.filterButtonText}>ID</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setSearchType('genre')} style={searchType === 'genre' ? styles.activeFilterButton : styles.filterButton}>
